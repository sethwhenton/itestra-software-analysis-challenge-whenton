...
import cronutils.mapper.WeekDay;
...
import cronutils.model.field.constraint.FieldConstraintsBuilder;
import cronutils.model.field.definition.DayOfWeekFieldDefinition;
import cronutils.model.field.expression.Always;
import cronutils.model.field.expression.QuestionMark;
import cronutils.model.time.generator.FieldValueGenerator;
import cronutils.model.time.generator.FieldValueGeneratorFactory;
import cronutils.model.time.generator.NoSuchValueException;
...
import static cronutils.model.field.value.SpecialChar.QUESTION_MARK;
import static cronutils.model.time.generator.FieldValueGeneratorFactory.*;
import static cronutils.utils.Predicates.not;
